...
export default function AdvancedSearch({ onSearch, isLoading = false }: AdvancedSearchProps) {
  ...
  const handleSearch = (query = searchQuery, filters = selectedFilters, fuzzy = fuzzyEnabled) => {
    onSearch(query, filters, fuzzy)
    setShowSuggestions(false)
  }
  
  const handleSuggestionClick = (suggestion: Suggestion) => {
    setSearchQuery(suggestion.balti)
    handleSearch(suggestion.balti)
  }
