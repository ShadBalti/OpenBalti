...
export function CulturalGallery() {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-background via-muted/30 to-background" aria-labelledby="gallery-heading">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
          <h2 id="gallery-heading" className="text-4xl md:text-5xl font-bold mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {galleryItems.map((item, index) => (
            ...
            >
              <div className="relative aspect-square overflow-hidden rounded-2xl border-2 border-primary/30 shadow-xl hover:shadow-2xl hover:shadow-primary/30 transition-all duration-500">
                <Image
                  src={item.image}
                  alt={item.title}
                  fill
